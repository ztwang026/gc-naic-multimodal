...
class DualResnet50Classifier(nn.Module):
    def __init__(self, pretrained=True, num_classes=2, dropout_rate=0.5):
        super().__init__()
        

        self.resnet_primary = models.resnet50(pretrained=pretrained)

        self.resnet_lymph = models.resnet50(pretrained=pretrained)
